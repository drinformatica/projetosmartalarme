...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Crie propostas profissionais, analise o retorno do investimento e acompanhe cada oportunidade até o fechamento." },
      { property: "og:title", content: "Intrusão 2.0 — Orçamentos, ROI e pipeline comercial" },
      { property: "og:description", content: "Crie propostas profissionais, analise o retorno do investimento e acompanhe cada oportunidade até o fechamento." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Intrusão 2.0 — Orçamentos, ROI e pipeline comercial" },
      { name: "twitter:description", content: "Crie propostas profissionais, analise o retorno do investimento e acompanhe cada oportunidade até o fechamento." },
