...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Orçamentos inteligentes, análise de ROI e gestão completa do pipeline de vendas — tudo em uma única plataforma." },
      { property: "og:title", content: "Intrusão 2.0 - Orçamentos & Pipeline" },
      { property: "og:description", content: "Orçamentos inteligentes, análise de ROI e gestão completa do pipeline de vendas — tudo em uma única plataforma." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Intrusão 2.0 - Orçamentos & Pipeline" },
      { name: "twitter:description", content: "Orçamentos inteligentes, análise de ROI e gestão completa do pipeline de vendas — tudo em uma única plataforma." },
