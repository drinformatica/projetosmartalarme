...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Plataforma para geração de propostas comerciais de alta conversão em PDF e pipeline de vendas e orçamentos de soluções." },
      { property: "og:title", content: "Intrusão 2.0 - Orçamentos & Pipeline" },
      { property: "og:description", content: "Plataforma para geração de propostas comerciais de alta conversão em PDF e pipeline de vendas e orçamentos de soluções." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Intrusão 2.0 - Orçamentos & Pipeline" },
      { name: "twitter:description", content: "Plataforma para geração de propostas comerciais de alta conversão em PDF e pipeline de vendas e orçamentos de soluções." },
